...
CREATE TABLE IF NOT EXISTS reviews (
  ...
  ai_summary TEXT,
  risk_reason TEXT,
  status TEXT NOT NULL DEFAULT 'new' CHECK (status IN ('new', 'drafted', 'needs_approval', 'replied')),
...
CREATE TABLE IF NOT EXISTS review_replies (
  ...
  final_text TEXT,
  status TEXT NOT NULL DEFAULT 'draft' CHECK (status IN ('draft', 'approval', 'posted', 'failed')),
