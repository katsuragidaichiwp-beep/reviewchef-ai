...
2. デモレビューが自動で表示されます。
3. `レビュー受信箱` でCSV取り込み、期間・星数・キーワード絞り込み、AI要約、リスク測定、返信案編集、承認投稿、一括自動返信候補の確認を試せます。
...
本番運用ではGoogle Business Profile APIの審査、OAuth、店舗オーナーまたは管理者権限、レビュー返信の明示的な許諾が必要です。一括自動返信も、P0/P1を除外し、店舗ごとの同意と管理者承認を前提に実行します。
